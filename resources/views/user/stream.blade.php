...
<div class="container">
    ...
    data-setup="{}">
            ...
            <source src="https://sin1.contabostorage.com/be47e31584b1436b879da3e76976fe73:streaming/stream/{{$data->short_file}}/{{$data->short_file}}_0_{{$data->resolusi}}.m3u8" type="application/x-mpegURL" />
