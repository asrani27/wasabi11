    ...
    document.addEventListener("DOMContentLoaded", async function () {
        ...
        var loadingSpinner = document.getElementById("loading-spinner");
            ...
            video.addEventListener("loadeddata", function () {
                console.log("loaded hidden from else");
                loadingSpinner.classList.add("hidden");
            });
        ...
        // Fullscreen + Auto Rotate ke Landscape
        function enterFullscreen() {
            ...
            // Kunci ke landscape saat fullscreen
                ...
                $('.chromecast').click(function () {
                    if (cjs.available) {
                        if (cjs.connected) {
                            ...
                            cjs.cast(castUrl, {
                                poster: 'https://convert.d-cdn.me/convert/aHR0cDovL3NrOS5kcmFrb3IuY2MvaW1hZ2VzLzIyLTIwMjUtMDMtMDYtYjFhZTIzNzBkZjBiNDQxN2FhNTU5ZTkyOGFiYmViMTIuanBn/1280x720/1.jpg',
                                title: 'vidio-drakor-id.mp4',
                                subtitles: []
                            })
                        }
                    }
        ...
        function initPlayer() {
            ...
            function sendEvent(name) {
                window.parent.postMessage({
                    channel: "bunnystream",
                    video: "d9c5738f-b4d0-4692-874e-2ad251250831",
                    event: name,
        ...
        function generateDrmRequest(initDataType, initData, keyContext){
            ...
            console.log("hidden hidden 1008");
            loadingSpinner.classList.add("hidden");
