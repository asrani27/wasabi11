        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    @else
                    <iframe style="width: 100%; height: 80%; overflow: hidden;" frameBorder="0" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" src="{{config('app.url')}}/stream/{{$data->short_file}}/"></iframe>
                    @endif
                </div>
                @if ($data->type == 'mp4') 
